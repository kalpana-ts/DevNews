# DevNews Back end Application

## Introduction

This is a backend project for a developer news site where users can create articles, 
comment them and post their reactions (likes, dislikes). 
